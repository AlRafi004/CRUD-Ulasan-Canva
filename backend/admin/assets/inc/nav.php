<!-- Program ini adalah bagian dari halaman HTML yang digunakan untuk menampilkan header dan navigasi admin panel ulasan Canva. 
Secara keseluruhan, program ini bertanggung jawab untuk menampilkan header dan elemen navigasi yang berhubungan 
dengan profil admin dan penggunaan sistem manajemen ulasan. -->
...
?>
    ...
    <div class="navbar-custom">
        ...
        <!-- LOGO -->
        <div class="logo-box">
            <a href="admin_add_review.php" class="logo text-center">
                <span class="logo-lg">
