<!-- Kode ini mengatur dan memperbarui profil pengguna serta kata sandi dengan mengambil data dari formulir, 
menyimpannya dalam database, dan menampilkan pesan keberhasilan atau kesalahan sesuai dengan hasil operasi. -->
<?php
	session_start();
